...
function SoundsSample(context) {
  ...
  var loader = new BufferLoader(context, 
            ['../audios/poopTalk_01.mp3',   // poop: 0~3
             '../audios/poopTalk_02.mp3',
             '../audios/poopTalk_03.mp3',
             '../audios/poopTalk_04.mp3',
             '../audios/longFart_1.mp3',    // 4 - heart
             '../audios/cuteFart_1.mp3',    // fart: 5~12
             '../audios/cuteFart_2.mp3',
             '../audios/shortFart_4.mp3',
             '../audios/shortFart_5.mp3',
