...
function superInit(){
	...
	*/
	...
	for(var i=0; i<7; i++){
		...
		// portal.position.set(
		// 	toiletCenters[0].x + Math.random() * 200 - 100,
		// 	100,
		// 	toiletCenters[0].z + Math.random() * 200 - 100 );
		...
		// poop tower
		// for(var j=0; j<10; j++){
		// 	var alienPoop = poop.clone();
		// 	alienPoop.position.set( portal.position.x, portal.position.y-5*j, portal.position.z);
		// 	scene.add(alienPoop);
		// 	poopTower.push();
		// }
		// poopTowers.push
	...
	setTimeout(function(){
		...
		for(var j=0; j<10; j++){
			...
			for(var i=0; i<portals.length; i++){
				...
				//v.2
				// alienPoop.rotation.y = Math.random() * Math.PI;
				...
				// alienPoop.rotation.y += Math.PI/4;
				// alienPoop.rotation.x = 0;
				// alienPoop.rotation.z = 0;
